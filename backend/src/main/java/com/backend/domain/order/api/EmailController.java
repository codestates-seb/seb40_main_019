...
public class EmailController {
    ...
    @ResponseBody
    @PostMapping("/confirm")
    String mailConfirm(@RequestBody EmailDto.RequestSendMail emailDto) throws Exception {
    ...
    String mailConfirmForUser(@RequestBody EmailDto.RequestSendMail emailDto) throws Exception {
